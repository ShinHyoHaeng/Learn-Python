...
window.title("사진 앨범")
window.configure(background="#000") # 윈도우의 배경색 변경(black)
...
pTitle = Label(window, text=fnameList[0])
pLabel = Label(window, image=photo)

# 버튼과 이미지 배치
btnPrev.place(x=250, y=20)
btnNext.place(x=400, y=20)
pTitle.place(x=310, y=20)
pLabel.place(x=20, y=60)
